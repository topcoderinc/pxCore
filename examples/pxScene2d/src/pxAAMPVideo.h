...
#ifndef PX_AAMP_VIDEO_H
#define PX_AAMP_VIDEO_H
...
class pxAAMPVideo: public pxObject
{
public:
  rtDeclareObject(pxAAMPVideo, pxObject);
...
public:
    static pxAAMPVideo *pxAAMPVideoObj; //This object
};

#endif // PX_AAMP_VIDEO_H
