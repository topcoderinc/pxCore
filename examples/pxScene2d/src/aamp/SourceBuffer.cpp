...
PlayerInstanceAAMP *SourceBuffer::getInstanceAamp() const
{
  return instanceAamp;
}

void SourceBuffer::setInstanceAamp(PlayerInstanceAAMP *instanceAamp)
{
  SourceBuffer::instanceAamp = instanceAamp;
}
