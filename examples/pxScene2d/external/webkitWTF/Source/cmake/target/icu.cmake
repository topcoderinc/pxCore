...
elseif (WIN32 AND NOT WTF_PLATFORM_WIN_CAIRO)
    ...
    set(ICU_I18N_LIBRARY ${WEBKIT_LIBRARIES_LINK_DIR}/icuin.lib)
    set(ICU_UC_LIBRARY ${WEBKIT_LIBRARIES_LINK_DIR}/icuuc.lib)

    set(ICU_DATA_LIBRARY ${WEBKIT_LIBRARIES_LINK_DIR}/icudt.lib)
